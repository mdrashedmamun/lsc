      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <ScrollReveal>
          <div className="relative w-full aspect-[3/4] md:aspect-[21/9] min-h-[600px] md:min-h-[700px] flex items-center justify-center mb-32 md:mb-56">
            <ProcessEngine />
            <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_50%_50%,rgba(184,134,11,0.05)_0%,transparent_70%)]"></div>
          </div>
        </ScrollReveal>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12">
              ...
              <div className="lg:col-span-8 p-12 md:p-16 flex flex-col justify-center">
                <p className="text-h3 !text-2xl md:!text-4xl text-cream/80 mb-10 leading-tight">
                  ...
                  <span className="text-bronze-metallic italic">Systems move them forward.</span>
                </p>
        ...
        <ScrollReveal>
          <div className="mt-56 p-20 md:p-32 hairline bg-white/[0.01] text-center relative group">
            ...
            <h3 className="text-h2 !text-3xl md:!text-6xl text-cream mb-16 relative z-10">
              Stop Being the <br className="hidden md:block"/> <span className="italic">Constraint.</span>
            </h3>
            <a 
              href={BOOKING_LINK} 
